"""Build the fifty-answer hand-check file for the segmenter.

Half the sample is random. Half is drawn from answers containing known
segmentation hazards (abbreviations, decimals, code fragments, break
tags) so the hard cases are actually exercised.
"""
